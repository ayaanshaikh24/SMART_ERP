    ...
    <DashboardLayout>
      <div className="flex flex-col gap-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-bold tracking-tight text-foreground sm:text-3xl">New Purchase Voucher</h1>
            <p className="text-sm text-muted-foreground">Record inward stock from suppliers and automatically increase item inventory levels</p>
          </div>
        </div>
        ...
        <form ref={formRef} onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="bg-card/50 border border-border p-5 rounded-xl space-y-4">
            <div className="flex items-center justify-between">
              <h3 className="text-sm font-semibold text-muted-foreground uppercase tracking-wider">Purchase Line Items</h3>
              <button
                type="button"
                      ...
                      <td className="py-3 pr-4">
                        ...
                        {item.stock_item_id && (
                          <div className="text-xs text-muted-foreground mt-1 pl-1">
                            Current Stock: <span className="font-semibold text-foreground">{item.available_stock} {item.unit}</span>
                          </div>
                        )}
                      </td>
                      <td className="py-3 pr-4">

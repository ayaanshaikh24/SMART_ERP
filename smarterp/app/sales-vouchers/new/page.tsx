    ...
    <DashboardLayout>
      <div className="flex flex-col gap-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-bold tracking-tight text-white sm:text-3xl">New Sales Voucher</h1>
            <p className="text-sm text-zinc-400">Generate a customer invoice bill and dynamically decrement stock levels</p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="bg-zinc-900/50 border border-zinc-800 p-5 rounded-xl space-y-4">
            <div className="flex items-center justify-between">
              <h3 className="text-sm font-semibold text-zinc-400 uppercase tracking-wider">Invoice Line Items</h3>
              <button
                type="button"
